            ...
            <div class="card-body">
                ...
                <table id="table_rfm" class="display" style="width:100%">
                 <thead>
                        <tr>
                        <th rowspan="3">ID</th>
                        <th rowspan="3">NO SPT</th>
                        <th rowspan="3">TGL SPT</th>
                        <th rowspan="3">TANGGAL Pengukuran</th>
                        <th rowspan="3">NO ISR</th>
                        
                        <th colspan="5">NAMA STASIUN RADIO SIARAN</th> 

                        <th colspan="7">LOKASI PEMANCAR</th>

                        <th colspan="14">SPESIFIKASI PERANGKAT</th>

                        <th colspan="12">HASIL UKUR</th> 
                        <th rowspan="3">STL</th>
                        ...
                        <th rowspan="2">ALAMAT</th>
                        <th rowspan="2">kab/kota</th>
                        <th rowspan="2">TINGGI LOKASI (mdpl)</th>
                        <th rowspan="2">TINGGI GEDUNG (m)</th>
                        <th rowspan="2">TINGGI MENARA (m)</th>

                        <!-- Sub-grup header 'PEMANCAR' -->
                        <th colspan="7">PEMANCAR</th>
                        <!-- Sub-grup header 'ANTENA' -->
                        <th colspan="7">ANTENA</th>
                        
                        <!-- Kolom untuk 'HASIL UKUR' -->
                        <th rowspan="2">KANAL</th>
                        <th rowspan="2">FREKUENSI TERUKUR</th>
                        <th rowspan="2">LEVEL</th>
                        <th rowspan="2">BANDWIDTH</th>
                        <th rowspan="2">FIELD STRENGTH</th>
                        <th rowspan="2">DAYA</th>
                        <th rowspan="2">MODULASI</th>
                        <th rowspan="2">DEVIASI</th>
                        <th rowspan="2">OUTPUT MAX</th>
                        <!-- Kolom untuk 'HARMONISA' -->
                        <th colspan="3">HARMONISA</th>
                        </tr>
...
<script>
        $(document).ready(function() {
            console.log($('#table_rfm')); // This should log the jQuery object for your table
            console.log($.fn.dataTable); // This should log the DataTables function if it's loaded
        $('#table_rfm').DataTable({
